...
use addons\YunStore\common\enums\VirtualProductGroupEnum;
use addons\YunStore\common\models\product\Product;
use addons\YunStore\common\models\product\VirtualType;
use addons\YunStore\common\models\SettingForm;
use addons\YunStore\merchant\controllers\BaseController;
use addons\YunStore\merchant\forms\ProductForm;
...
class ProductController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render($this->action->id, [
            ...
            'cates' => Yii::$app->yunStoreService->productCate->getMapList(),
    ...
    public function actionEdit()
    {
        ...
        $model->defaultMemberDiscount = Yii::$app->yunStoreService->productMemberDiscount->getLevelListByProductId($id);
        ...
        // 分销配置
        $commissionRate = Yii::$app->yunStoreService->productCommissionRate->findModelByProductId($id);
        ...
        // 获取参数、规格和规格值、已选规格值
        list($attributeValue, $specValue, $specValuejsData) = Yii::$app->yunStoreService->product->getSpecValueAttribute($model);
        // 阶梯折扣
        ...
        return $this->render($this->action->id, [
            'model' => $model,
            'cates' => Yii::$app->yunStoreService->productCate->getMapList(),
            'brands' => Yii::$app->yunStoreService->productBrand->getMapList(),
            'tags' => Yii::$app->yunStoreService->productTag->getMapByList($model->tags),
            ...
            'baseAttribute' => Yii::$app->yunStoreService->baseAttribute->getMapList(), // 基础类型
    ...
    {
        // 属性值
        $data = Yii::$app->yunStoreService->baseAttribute->getDataById($base_attribute_id);
        $value = $data['value'] ?? [];
        ...
        $spec_ids = $spec_ids ?? [];
        $spec = Yii::$app->yunStoreService->baseSpec->getListWithValueByIds($spec_ids);
