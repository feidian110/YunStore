...
/**
 * This is the model class for table "yun_net_addon_yun_store_product".
 *
 * @property int $id
...
class Product extends \common\models\base\BaseModel
{
    ...
    {
        return '{{%addon_yun_store_product}}';
    }
