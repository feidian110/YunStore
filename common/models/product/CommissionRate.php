...
/**
 * This is the model class for table "yun_net_addon_yun_store_product_commission_rate".
 *
 * @property int $id
 * @property int $merchant_id 商户id
 * @property int $product_id 商品ID
 * @property string $distribution_commission_rate 分销佣金比率
 * @property string $regionagent_commission_rate 区域代理分红佣金比率
...
class CommissionRate extends \common\models\base\BaseModel
{
    ...
    {
        return '{{%addon_yun_store_product_commission_rate}}';
    }
