...
/**
 * This is the model class for table "yun_net_addon_yun_store_product_brand".
 *
 * @property int $id
...
class Brand extends \common\models\base\BaseModel
{
    ...
    {
        return '{{%addon_yun_store_product_brand}}';
    }
    ...
    {
        if (Yii::$app->yunStoreService->productBrand->findByTitle($this->title)) {
